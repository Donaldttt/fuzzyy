...
#       - raw_entry_handle: a function that processes raw entry and return
#           useful infomation such as file name or buffer name
# return:
...
export def Start(li_raw: list<string>, opts: dict<any>): dict<any>
    ...
    cbs = {}
    cbs.raw_entry_handle = has_key(opts, 'raw_entry_handle') &&
        type(opts.raw_entry_handle) == v:t_func ?
        opts.raw_entry_handle : v:null
